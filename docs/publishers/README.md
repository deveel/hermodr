...
| [Dead-Letter Handling and Replay](reliability/dead-letter/README.md) | `Hermodr.Publisher.DeadLetter` | Capturing failed channel deliveries, persisting them, and replaying them later |
