...
| **New Transports** | **v1.5.0–v1.5.x** | CloudEvents HTTP binding compliance for the Webhook publisher (shipped **v1.5.0**), the Dapr pub/sub building-block channel (shipped **v1.5.1**), and the lightweight HTTP publish channel (shipped **v1.5.2**). The remaining broker-agnostic adapters — gRPC streaming, Apache Kafka, and NATS/JetStream — stay targeted within the **v1.5.x** line. Cloud-provider-specific adapters (Amazon SQS, Amazon SNS, Google Cloud Pub/Sub) have been deferred to v2.4.0.                                                                                                                                                                                                                                                                                                                                                                              | 12 · 44 · 13 (shipped); 14 · 15 · 19 → v1.5.x |
...
## Transport & Channels — Delivered across v1.5.0–v1.5.2

> The webhook CloudEvents HTTP binding compliance (item 12) shipped in **v1.5.0**; the Dapr pub/sub channel (item 44) shipped in **v1.5.1**; the lightweight HTTP channel (item 13) shipped in **v1.5.2**. The remaining broker-agnostic adapters — gRPC streaming (item 14), Apache Kafka (item 15), and NATS/JetStream (item 19) — stay targeted within the **v1.5.x** line.
...
> ✅ **Delivered in v1.5.2.** See [HTTP Channel](publishers/http.md) for usage.
...
> ✅ **Delivered in v1.5.1.** See [Dapr Channel](publishers/dapr.md) for usage.
