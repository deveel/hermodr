    ...
    public class CloudEventValidationTests {
        ...
        public async Task PublishEvent_MissingType_ThrowsInvalidCloudEventException() {
            ...
            var ex = await Assert.ThrowsAsync<InvalidCloudEventException>(
                () => _publisher.PublishEventAsync(@event, cancellationToken:TestContext.Current.CancellationToken));
        ...
        public async Task PublishEvent_MissingId_ThrowsInvalidCloudEventException() {
            ...
            var ex = await Assert.ThrowsAsync<InvalidCloudEventException>(
                () => publisher.PublishEventAsync(@event, cancellationToken: TestContext.Current.CancellationToken));
        ...
        public async Task PublishEvent_AllRequiredAttributesPresent_Succeeds() {
            ...
            await _publisher.PublishEventAsync(@event, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task PublishEvent_SourceFromOptions_PassesValidation() {
            ...
            await optionalPublisher.PublishEventAsync(@event, cancellationToken: TestContext.Current.CancellationToken);
