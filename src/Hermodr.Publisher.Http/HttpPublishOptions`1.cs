...
{
    /// <summary>
    /// Type-specific publish options for a <see cref="HttpPublishChannel{TEvent}"/>
    ...
    /// general-purpose <see cref="HttpPublishOptions"/> registered alongside
    /// the non-typed channel.
    /// </remarks>
    /// <typeparam name="TEvent">
    /// The event data class this set of options is keyed against.
    /// </typeparam>
    public class HttpPublishOptions<TEvent> : HttpPublishOptions
        where TEvent : class
    {
    }
}